...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Product Hunt Post</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <nav className="flex items-center w-full justify-between flex-wrap bg-blue-500 p-6">
      ...
      <div className={styles.container}>
        {loading ? (
          <>
            <div className="border border-blue-300 shadow rounded-md p-10 m-10 mx-auto">
